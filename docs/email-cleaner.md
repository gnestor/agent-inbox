...
## HTML Sanitizing (`sanitizeHtmlEmail`)
...
| `<div style="border:none;border-top:solid...">` | Outlook desktop / Apple Mail |
| `<div class="reply-timestamp-box">` | GoHighLevel / Lead Connector |
...
| `On...wrote` | `On Mon Apr 21, 2025 at...wrote:` — allows HTML tags between "On" and weekday/month |
...
| `19beace60dce19c1.html` | `reply-timestamp-box` div (GoHighLevel / Lead Connector) |
...
After deploying sanitizer changes, existing cached threads won't be re-sanitized until they expire (5 min TTL). To force a refresh immediately:
